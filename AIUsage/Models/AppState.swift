...
class AppState: ObservableObject {
    ...
    private static let providerCatalogItems: [ProviderCatalogItem] = [
        ...
        ProviderCatalogItem(id: "glm", titleEn: "GLM Coding Plan", titleZh: "GLM Coding Plan", summaryEn: "GLM Coding Plan 5-hour and weekly subscription credits", summaryZh: "GLM Coding Plan 的 5 小时与周窗口订阅额度", channel: "cli", kind: .official),
