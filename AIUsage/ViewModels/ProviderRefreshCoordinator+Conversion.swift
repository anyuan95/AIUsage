...
extension ProviderRefreshCoordinator {
    ...
    private static let exactTranslations: [String: String] = [
            ...
            "tightest GLM Coding Plan window": "最紧张的 GLM Coding Plan 窗口",
            "GLM Coding Plan usage": "GLM Coding Plan 订阅用量",
            "GLM Coding Plan": "GLM Coding Plan",
            "5h Window": "5 小时窗口",
            "Weekly Window": "周窗口",
            "Coding Plan": "编程套餐",
            "GLM Coding Plan shares one credit pool across CLI, IDE, and API keys. The 5-hour rolling window recovers after use; the weekly window resets every 7 days. China and International keys are not interchangeable.": "GLM Coding Plan 的 CLI、IDE 与 API Key 共用同一份积分额度。5 小时滚动窗口用后回补；周限每 7 天重置。国内与海外 Key 不能混用。",
